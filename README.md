...
- 运行时主线：[`docs/00-architecture-overview.md#runtime-mainline`](./docs/00-architecture-overview.md#runtime-mainline)
- Team 章节：[`docs/09-team-runtime.md`](./docs/09-team-runtime.md)
