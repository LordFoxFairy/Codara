...
command-description: "Code review a pull request"
command-usage: /code-review
allowed-tools: Bash(gh issue view:*), Bash(gh search:*), Bash(gh issue list:*), Bash(gh pr comment:*), Bash(gh pr diff:*), Bash(gh pr view:*), Bash(gh pr list:*)
metadata:
  imported-from-plugin: code-review
  source-command: code-review.md
---

# Imported Plugin Command: /code-review

This skill was generated from the code-review plugin command `code-review.md`.
