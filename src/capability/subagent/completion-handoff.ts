...
export function buildAgentCompletionHandoff(context: BeforeModelContext): string | undefined {
...
export function maybeHandleAgentCompletionToolCall(context: ToolCallContext): ToolMessage | undefined {
