/**
 * Presentational blocks for text-role transcript items and tool results.
 *
 * - TranscriptBlock: generic role-tagged text block (user / assistant / system / ...).
 * - ToolResultBlock: structured tool invocation + output rendering.
 */
import React from 'react';
import {Box, Text} from 'ink';
import type {ToolResultMeta, TranscriptRole} from './model';
...
export function getRolePrefix(role: TranscriptRole): {text: string; width: number} {
  switch (role) {
