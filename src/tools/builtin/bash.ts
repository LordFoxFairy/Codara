...
// Re-export registry so existing consumers can keep importing from '@tools/builtin/bash'.
export {backgroundProcesses, BackgroundProcessRegistry, type BackgroundProcessInfo} from '@tasks/shell-task';
